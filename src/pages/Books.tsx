          ...
          <div className="grid grid-cols-12 gap-4 items-center py-4 mx-8">
            ...
            <div className="col-span-12 md:col-span-8 flex justify-center items-center relative">
              <div className="grid grid-cols-3 md:grid-cols-6 gap-y-2 md:gap-2">
                ...
                <div className="border-e-2 border-[#E0E0E0] text-center p-2">
                  <Link to="/about" className="inline-block px-2 text-md text-dark uppercase">About Us</Link>
                </div>
                <div className="border-e-2 border-[#E0E0E0] text-center p-2">
                  <Link to="/books" className="inline-block px-2 text-md text-orange uppercase">Books</Link>
                </div>
                <div className="border-e-2 border-[#E0E0E0] text-center p-2">
                  <a href="#new-release" className="inline-block px-2 text-md text-dark uppercase">New Release</a>
                </div>
                <div className="border-e-2 border-[#E0E0E0] text-center p-2">
